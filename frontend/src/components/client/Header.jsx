      ...
      >
        <div className='headerList'>
          <div className='headerListItem '>
            <p>
              <FontAwesomeIcon className='f_I' icon={faBed} />
            </p>
          ...
          <div className='headerListItem '>
            <p>
              <FontAwesomeIcon className='f_I' icon={faImage} />
            </p>
            <Link
              to='/listblogs'
          ...
          <div className='headerListItem'>
            <p>
              <FontAwesomeIcon className='f_I' icon={faUserCircle} />
            </p>
            <Link
              to='/profile'
              style={{ color: 'inherit', textDecoration: 'none' }}
          ...
          <div className='headerListItem'>
            <p>
              <FontAwesomeIcon className='f_I' icon={faInfoCircle} />
            </p>
            <span>About Us</span>
          </div>
          {/* <div className="headerListItem">
        ...
        {type !== 'list' && (
          <>
            ...
            <p className='headerDesc'>
              flexible booking options on holiday homes, hotels,
              apartments,casinos and more
            </p>
